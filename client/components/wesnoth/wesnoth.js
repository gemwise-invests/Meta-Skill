...
angular.module('mudServerApp.wesnoth', [])
    .factory('Wesnoth', () => {
        return {
            HexMap: new window.WesnothTiles.Angular.HexMap(),
            Tiles: window.WesnothTiles,
            EOverlay: window.EOverlay,
            ETerrain: window.ETerrain
        }
    })
